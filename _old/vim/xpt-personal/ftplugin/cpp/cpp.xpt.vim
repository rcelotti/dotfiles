...
XPT varXXX hint=Creates\ accessors\ for\ a\ variable
/**
...
`cursor^`type^ m`varName^;

`get...^
XSETm get...|post
/**
 * Returns the value of `R("varName")^.
 *
 * @return `R("varName")^.
 */
const `R("type")^ get`S(R("varName"),'.','\u&',"")^() const { 
    return m`R("varName")^; 
}
 ...
 * Sets `R("varName")^.
 *
 * @param value The new value for `R("varName")^.
 */
void set`S(R("varName"),'.','\u&',"")^(const `R('type')^ value) { 
    m`R("varName")^ = value; 
}
...
XPT varr hint=Creates\ accessors\ for\ a\ variable\ with\ references
`cursor^`type^ m`varName^;

`get...^
XSETm get...|post
/**
 * Returns the const reference to `R("varName")^.
 *
 * @return `R("varName")^ const reference.
 */
const `R("type")^& get`S(R("varName"),'.','\u&',"")^() const { 
    return m`R("varName")^; 
}
